...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Olá. Qual a ação você deseja?';
...
const OracleIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'oracle';
    },
    async handle(handlerInput) {

        const url = 'https://oic-digidev-ladsedigdev.integration.ocp.oraclecloud.com/ic/api/integration/v1/flows/rest/CRISTIAN_HOSHIKAW_ORACLE_QUOTE/1.0/oraclequote';
        var speakOutput = '';
